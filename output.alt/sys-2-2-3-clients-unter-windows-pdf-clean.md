---
source_file: "SYS.2.2.3-Clients-unter-Windows.pdf.clean.pdf"
source_sha256: 0c90811db72f9bc1368cdbf8f2336eae4fa04a02eae60d8c1303f4bd28f1fd17
source_bytes: 155106
pages: 7
tables: 1
...
converted_at: "2026-08-31T20:56:17+00:00"
text_coverage_percent: 100.0
restored_hyphens: 3
extraction_status: warn
warnings:
  - "3 Wort(e) hatten einen Bindestrich der Quelle verloren und wurden zurueckgesetzt (belegt durch den Textlayer): MicrosoftAccount -> Microsoft-Account, RemoteDesktopzugriff -> Remote-Desktopzugriff, WindowsRemoteunterstützung -> Windows-Remoteunterstützung"
...
- [Konfigurieren von zusätzlichem LSA-Schutz: https://docs.microsoft.com/de-de/windowsserver/security/credentials-protection-and-management/configuring-additional-lsaprotection](https://docs.microsoft.com/de-de/windows-server/security/credentials-protection-and-management/configuring-additional-lsa-protection)
- [Credential Guard - Überblick: https://docs.microsoft.com/de-de/windows/accessprotection/credential-guard/credential-guard-requirements](https://docs.microsoft.com/de-de/windows/access-protection/credential-guard/credential-guard-requirements)
- [Device Guard - Überblick: https://technet.microsoft.com/de-de/library/dn986865.aspx](https://technet.microsoft.com/de-de/library/dn986865.aspx)
