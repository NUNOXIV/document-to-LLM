---
source_file: "CCON.11.1-Geheimschutz-VS-NUR-FU-R-DEN-DIENSTGEBRAUCH-VS-NfD-.pdf.clean.pdf"
source_sha256: 2cb8247ba4433c144eb267db8bc782d11bab166390be6bb8c68c2cc4df673563
source_bytes: 191929
pages: 11
tables: 1
...
converted_at: "2026-08-31T17:37:50+00:00"
text_coverage_percent: 100.0
restored_hyphens: 4
extraction_status: warn
warnings:
  - "4 Wort(e) hatten einen Bindestrich der Quelle verloren und wurden zurueckgesetzt (belegt durch den Textlayer): ITDokumentation -> IT-Dokumentation, ITProdukten -> IT-Produkten, ITSicherheitsprodukt -> IT-Sicherheitsprodukt, ITSicherheitsprodukte -> IT-Sicherheitsprodukte"
...
Der Baustein CON.11.1 Geheimschutz VS-NUR FÜR DEN DIENSTGEBRAUCH (VS-NfD) ist einmal auf den gesamten Informationsverbund der VS-IT anzuwenden, falls VS des Geheimhaltungsgrades VSNfD verarbeitet werden oder werden sollen. Dieser Baustein richtet sich an Bundesbehörden oder bundesunmittelbare öffentlich-rechtliche Einrichtungen, die der VSA unterliegen.
...
Als konspirativer Angriff wird eine Form der Spionage bezeichnet, bei der Informationen verdeckt von nicht öffentlich zugänglichen Informationen durch ausländische Nachrichtendienste gewonnen werden. Bei konspirativen Angriffen möchten Nachrichtendienste möglichst unbemerkt an für sie interessante Informationen, wie z. B. VS, gelangen. Bei konspirativen Beschaffungsaktivitäten verschleiern die Nachrichtendienste ihre wahren Absichten. Die Informationen werden über den Einsatz menschlicher Quellen (z. B. Social Engineering), durch technische Mittel (z. B. Abhörmaßnahmen oder Cyber-Angriffe, bei denen Hintertüren ausgenutzt oder Schadsoftware eingesetzt wird) oder durch eine Kombination beider Möglichkeiten beschafft. Vorteil gegenüber der Bundesrepublik Deutschland oder eines ihrer Länder verschaffen. Beispielsweise Bundesrepublik Deutschland zu stärken. Auch andere Gruppierungen, wie beispielsweise terroristische

In der Folge können ausländische Nachrichtendienste auf VS zugreifen und sich einen strategischen könnten andere Staaten diese Informationen nutzen, um ihre Verhandlungsposition gegenüber der Organisationen oder die organisierte Kriminalität, können mit den aus konspirativen Angriffen erlangten Informationen mögliche Aktivitäten effektiver planen und durchführen.
